...
export const copy = {
  fr: {
    ...
    privacyDocs:
      'Passeport, relevé bancaire et NINA sont chiffrés (AES-256-GCM) et accessibles uniquement à l’équipe Embassy / AmCham.',
    ...
    form: {
      ...
      fileHint: 'PDF, JPG ou PNG · {max} Mo max.',
      consent:
      ...
      successTitle: 'Votre dossier est en mouvement.',
      successBody:
        'Merci. L’équipe étudiera votre candidature et vous contactera si votre profil est retenu pour la délégation malienne à RE+ 2026. Vous pouvez aussi écrire à replusevent@amchammali.org.',
  ...
  en: {
    ...
    privacyDocs:
      'Passport, bank statement and NINA files are encrypted (AES-256-GCM) and visible only to the Embassy / AmCham team.',
    ...
    form: {
      ...
      fileHint: 'PDF, JPG or PNG · {max} MB max.',
      consent:
      ...
      successTitle: 'Your file is in motion.',
      successBody:
        'Thank you. The team will review your application and contact you if you are selected for the Malian delegation to RE+ 2026. You may also write to replusevent@amchammali.org.',
